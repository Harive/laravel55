            ...
            <div class="row mt">
                <div class="col-lg-12">
                    <div class="form-panel">
                        <h4 class="mb"></h4>
                        <form action="/user/updateas" class="form-horizontal style-form" method="post">
                            <input type="hidden" name="id" value="{{$info->id}}">
                            {{csrf_field()}}
                            <div class="form-group">
                                <label class="col-sm-2 col-sm-2 control-label">昵称</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control round-form" name="nickname" value="{{$info->nickname}}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 col-sm-2 control-label">性别</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control round-form" name="gender" value="{{$info->gender}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control round-form" name="signature" value="{{$info->signature}}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 col-sm-2 control-label">邮箱</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control round-form" name="email" value="{{$info->email}}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 col-sm-2 control-label">手机号</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control round-form" name="telphone" value="{{$info->telphone}}"><br><br>
                                    <td class="nav pull-right top-menu">
                                        <input type="submit" value="提交修改" class="logout">
                                    </td>
                                </div>
                            </div>
                            {{--<div class="form-group">--}}
