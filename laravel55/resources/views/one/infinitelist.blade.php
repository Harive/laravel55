      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>导航栏</h3>
          		...
          		<div class="col-md-12">
          			<div class="white-panel pn">
	                	<div class="panel-heading">
	                        <div class="pull-left"><h5><i class="fa fa-tasks"></i>导航栏详情</h5></div>
	                        <br>
	                 	</div>
				  		<div class="custom-check goleft mt">
				             <table id="todo" class="table table-hover custom-check">
				              <tbody>
				                ...
				                <tr>
				           			<td>
				                        <span class="check">导航名</span>
				                        <a href="#">{{$v->priv_name}}</a></span>
									</td>
				                </tr>
				                <tr>
				           			<td>
				                        <span class="check">导航链接地址</span>
				                        <a href="#">{{$v->priv_link}}</a></span>
									</td>
				                </tr>
				                <tr>
				            		<td>
				                        <span class="check">导航栏父id</span>
