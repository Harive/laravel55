          ...
          <section class="wrapper site-min-height">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" method="post" action="/one/carouselinsert" enctype="multipart/form-data">
                      		{{csrf_field()}}
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="car_sort">
                              </div>
                          </div>
                         <div>
