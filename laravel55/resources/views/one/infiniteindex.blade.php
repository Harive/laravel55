                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                           <a href="/one/infiniteinsert"><button>添加导航信息</button></a>
                              ...
                              @foreach($data as $v)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/one/infiniteupdate/{{$v->id}}"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
                                        <a href="/one/infinitedelete/{{$v->id}}"><button class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button></a>
                                    </td>
                                </tr>
                             @endforeach
                             <tr>
  ...
  <script>
      ...
      //全选
        ...
        function del(){
          ...
          str= str.substr(1)
          // alert(str)
          location.href="/one/infinitedelete2/"+str;
        }
        //搜索
        function search(){
          var sear=document.getElementById("search").value;
          // alert(sear);
          location.href="/one/infinitesearch/"+sear;
        }
  </script>
@endsection
