            ...
            <div class="row mt">
              <div class="col-lg-12">
                  <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i>修改导航栏分类</h4>
                      @foreach($data as $v)
                      <form class="form-horizontal style-form" method="post" action="/one/infiniteupdate/{{$v->id}}">
                          {{csrf_field()}}
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="priv_name" value="{{$v->priv_name}}">
                              </div>
                          </div>
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  @foreach($res as $k)
                                    <option value="{{$k->id}}">{{$k->priv_name}}</option>
                                  @endforeach
                                  </select>
                              </div>
                          </div>
